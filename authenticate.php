...
// QPBEF - QUERY, PREPARE, BIND, EXECUTE, FETCH
$admin_query = "SELECT user_name, passwords, user_role 
    FROM Admins 
...
// DIRECT TO HOMEPAGE
    if ( isset($_GET['directto']) && 
         $_GET['directto'] === "homepage"
    ) {
        header("Location: index.php?message=success");
        exit();
    }

// DIRECT TO ADD PLAYER
    if ( isset($_GET['directto']) && 
         $_GET['directto'] === "add"
    ) {
